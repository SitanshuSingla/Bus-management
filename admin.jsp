...
9810355724</div>
       ...
       <div class="e"><b><h1>Schedule</h1></b><div>                <form action="searchServlet" class="f">  Search:<input type="text" placeholder="Enter routeno"  name="user" />
                ...
                Route :<br><input type="text" name="route"><br>
                    Bus No. :<br><input type="text" name="busno" ><br>
                          Driver Name :<br><input type="text" name="na" ><br>
                              ...
                              <br><br>
                              <a href="update.jsp">  <button  class="g2">Edit</button></a>
                           <a href="delete.jsp">   <button class="g3">Delete</button></a><br><br>
               <table id="table">
